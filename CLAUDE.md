...
notes/                 # メモ・議事録
├── meetings/          # 議事録
├── contacts/          # ヒアリング対象者・関係者プロフィール
├── ideas/             # アイデアメモ
├── research/          # 調査メモ
└── misc/              # その他
assets/                # ファイル資料（PDF、PowerPoint等）
...
4. `docs/01_discovery/competitive-analysis.md` - 競合分析
5. `docs/02_strategy/mvp-definition.md` - MVP定義
6. `docs/02_strategy/roadmap.md` - ロードマップ
